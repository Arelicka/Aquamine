...
class McRegion extends BaseLevelProvider{
	...
	public static function getRegionIndex(int $chunkX, int $chunkZ, ?int &$x, ?int &$z){
		$x = $chunkX >> 5;
		$z = $chunkZ >> 5;
	}
	...
	protected function getRegion(int $x, int $z) : ?RegionLoader{
		return $this->regions[Level::chunkHash($x, $z)] ?? null;
	}

	protected function loadRegion(int $x, int $z) : void{
